          ...
          <Reveal>
            <div className="space-y-6">
              ...
              <h1 className="max-w-3xl text-5xl leading-tight md:text-7xl">
                為現代品牌與重要時刻打造
                <span className="gold-text">暗黑奢華影像</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  href="/portfolio"
                  className="focus-luxury inline-flex items-center rounded-full border border-border bg-secondary/40 px-6 py-3 text-sm tracking-[0.14em] uppercase hover:border-primary/60"
                >
                  瀏覽作品集
                </Link>
              </div>
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
                {heroStats.map((metric) => (
                  <div key={metric.label} className="rounded-xl border border-border/70 bg-background/30 p-4">
                    <p className="text-3xl gold-text">{metric.value}</p>
