    ...
    <PageShell path="/systems">
            ...
            <div className="overflow-hidden rounded-xl border border-border/40 bg-white/70 p-3">
              <div className="relative overflow-hidden rounded-xl">
                ...
                <div className="absolute right-5 bottom-5 left-5">
                  <p className="text-[0.7rem] font-medium tracking-[0.14em] text-white/80 uppercase">Operation Stack</p>
      ...
      <SectionShell className="pt-0">
        <div className="container-ultra">
          ...
          <Reveal>
            <PremiumCard>
              <div className="grid grid-cols-1 gap-2 rounded-xl border border-border/40 bg-background/25 p-3 md:grid-cols-4">
              ...
              <div className="mt-3 space-y-2">
                {systemRows.map((row) => (
                  <div
                    key={row.module}
                    className="grid grid-cols-1 gap-2 rounded-xl border border-border/40 bg-secondary/30 p-3 text-sm md:grid-cols-4"
                  >
        ...
        <div className="container-ultra grid gap-5 lg:grid-cols-2">
          <Reveal>
            <PremiumCard className="h-full">
              <p className="text-[0.7rem] font-medium tracking-[0.14em] text-foreground/50 uppercase">自動化規則</p>
              <h3 className="mt-3 text-xl font-semibold">在幕後穩定運作的流程</h3>
          ...
          <Reveal delay={0.08}>
            <PremiumCard className="h-full">
              <p className="text-[0.7rem] font-medium tracking-[0.14em] text-foreground/50 uppercase">每週複審節奏</p>
              <h3 className="mt-3 text-xl font-semibold">持續追蹤的核心數據</h3>
              <ul className="mt-5 space-y-3 text-sm text-muted-foreground">
          ...
          <Reveal>
            <PremiumCard>
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                  <p className="text-[0.7rem] font-medium tracking-[0.14em] text-foreground/50 uppercase">系統導入</p>
                  <h3 className="mt-2 text-xl font-semibold">需要把這套流程複製到你的團隊？</h3>
